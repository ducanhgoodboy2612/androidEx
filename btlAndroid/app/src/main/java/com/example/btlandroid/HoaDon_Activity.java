...
//        database.queryData("INSERT INTO CTHD VALUES(5,'Burger gà Hoàng Gia', 2)");
//        database.queryData("INSERT INTO CTHD VALUES(5,'Burger gà sốt cay', 3)");
//        database.queryData("INSERT INTO CTHD VALUES(5,'Burger bò phomai đặc biệt', 2)");
...
//    }
    ...
    public void DialogXoa(int maHD){
        ...
        dialogXoa.setMessage("Bạn có chắc chắn muôn xóa hóa đơn này không ?");
        dialogXoa.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                database.queryData("DELETE FROM HoaDon WHERE Id = '"+maHD+"'");
                Toast.makeText(HoaDon_Activity.this, "Da xoa", Toast.LENGTH_SHORT).show();
                GetData();
            }
        });
