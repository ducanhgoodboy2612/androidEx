...
public class Toan extends AppCompatActivity implements View.OnClickListener {
    ...
    int score = 0;
    int TongCauHoi = QuestionAnswerToan.question.length;
    ...
    private void handleNextButtonClick() {
        ...
        if (!answeredQuestions[viTriCauHoiHienTai]) {
            ...
            if (selectedAnswer.equals(QuestionAnswerToan.correctAnswers[viTriCauHoiHienTai])) {
                score++;
            }
    ...
    private void handleSubmitButtonClick() {
        ...
        Intent intent = new Intent(Toan.this, KetQua.class);
        //Khai báo Bundle
        Bundle bundle = new Bundle();
        //Đưa dữ liệu chuỗi vào bundle
        bundle.putString("tenMon", "Toán");
    ...
    private void loadNewQuestion() {
        ...
        question.setText(QuestionAnswerToan.question[viTriCauHoiHienTai]);
        //Hiển thị nội dung đáp án
        ansA.setText(QuestionAnswerToan.choices[viTriCauHoiHienTai][0]);
        ansB.setText(QuestionAnswerToan.choices[viTriCauHoiHienTai][1]);
        ansC.setText(QuestionAnswerToan.choices[viTriCauHoiHienTai][2]);
        ansD.setText(QuestionAnswerToan.choices[viTriCauHoiHienTai][3]);
