...
public class KhoaHoc extends AppCompatActivity implements View.OnClickListener {
    ...
    int score = 0;
    int TongCauHoi = QuestionAnswerKhoaHoc.question.length;
    ...
    private void handleNextButtonClick() {
        ...
        if (!answeredQuestions[viTriCauHoiHienTai]) {
            ...
            if (selectedAnswer.equals(QuestionAnswerKhoaHoc.correctAnswers[viTriCauHoiHienTai])) {
                score++;
            }
    ...
    private void handleSubmitButtonClick() {
        ...
        Intent intent = new Intent(KhoaHoc.this, KetQua.class);
        //Khai báo Bundle
        Bundle bundle = new Bundle();
        //Đưa dữ liệu chuỗi vào bundle
        bundle.putString("tenMon", "Khoa học");
    ...
    private void loadNewQuestion() {
        ...
        question.setText(QuestionAnswerKhoaHoc.question[viTriCauHoiHienTai]);
        //Hiển thị nội dung đáp án
        ansA.setText(QuestionAnswerKhoaHoc.choices[viTriCauHoiHienTai][0]);
        ansB.setText(QuestionAnswerKhoaHoc.choices[viTriCauHoiHienTai][1]);
        ansC.setText(QuestionAnswerKhoaHoc.choices[viTriCauHoiHienTai][2]);
        ansD.setText(QuestionAnswerKhoaHoc.choices[viTriCauHoiHienTai][3]);
