...
public class TiengAnh extends AppCompatActivity implements View.OnClickListener {
    ...
    int score = 0;
    int TongCauHoi = QuestionAnswerTiengAnh.question.length;
    ...
    private void handleNextButtonClick() {
        ...
        if (!answeredQuestions[viTriCauHoiHienTai]) {
            ...
            if (selectedAnswer.equals(QuestionAnswerTiengAnh.correctAnswers[viTriCauHoiHienTai])) {
                score++;
            }
    ...
    private void handleSubmitButtonClick() {
        ...
        Intent intent = new Intent(TiengAnh.this, KetQua.class);
        //Khai báo Bundle
        Bundle bundle = new Bundle();
        //Đưa dữ liệu chuỗi vào bundle
        bundle.putString("tenMon", "Tiếng Anh");
    ...
    private void loadNewQuestion() {
        ...
        question.setText(QuestionAnswerTiengAnh.question[viTriCauHoiHienTai]);
        //Hiển thị nội dung đáp án
        ansA.setText(QuestionAnswerTiengAnh.choices[viTriCauHoiHienTai][0]);
        ansB.setText(QuestionAnswerTiengAnh.choices[viTriCauHoiHienTai][1]);
        ansC.setText(QuestionAnswerTiengAnh.choices[viTriCauHoiHienTai][2]);
        ansD.setText(QuestionAnswerTiengAnh.choices[viTriCauHoiHienTai][3]);
